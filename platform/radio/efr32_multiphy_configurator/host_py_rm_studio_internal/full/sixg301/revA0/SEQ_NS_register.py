...
class RM_Register_SEQ_NS_SPARE4(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_SEQ_NS_SPARE4, self).__init__(rmio, label,
            0xb0000000, 0x010,
            'SPARE4', 'SEQ_NS.SPARE4', 'read-write',
            u"",
            0x00000000, 0x00000000,
            0x00001000, 0x00002000,
            0x00003000)

        self.SPARE4 = RM_Field_SEQ_NS_SPARE4_SPARE4(self)
...
class RM_Register_SEQ_NS_MODEMINFO(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.SPARE1 = RM_Field_SEQ_NS_MODEMINFO_SPARE1(self)
        ...
        self.SPARE2 = RM_Field_SEQ_NS_MODEMINFO_SPARE2(self)

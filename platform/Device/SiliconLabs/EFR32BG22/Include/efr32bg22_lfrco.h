 ...
 * Frequency RC Oscillator (LFRCO) registers for the EFR32BG22
 * microcontroller. It includes various control, status, and
 * configuration registers, as well as interrupt flag and enable
 * registers. The structure also provides set, clear, and toggle versions
 * of these registers, allowing for flexible manipulation of the
 * oscillator's operation. Reserved fields are included for future

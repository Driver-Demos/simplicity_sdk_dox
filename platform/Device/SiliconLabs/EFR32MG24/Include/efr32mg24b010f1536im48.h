 ...
 * such as Non-Maskable Interrupt and Hard Fault, and positive values for
 * peripheral interrupts, such as TIMER0 and USART0_RX. This enumeration
 * is used to identify and manage the various interrupt sources in the
 * system, allowing for the configuration and handling of interrupts in

...
/***************************************************************************//**
 * @brief The `I2C_TypeDef` structure represents the register map for an I2C
 ...
 * data registers for both receive and transmit operations. Additionally,
 * it includes reserved spaces for future use and multiple versions of
 * each register for setting, clearing, and toggling operations, allowing
 * for flexible control over the I2C peripheral's behavior.
 *

...
/***************************************************************************//**
 * @brief The `CMU_TypeDef` structure is a comprehensive representation of the
 * Clock Management Unit (CMU) registers for the EFR32MG24
 * microcontroller. It includes various registers for managing clock
 * configurations, status, and control for different peripherals and
 * system components. The structure is designed to facilitate the
 * manipulation of clock settings, including enabling and disabling
 * clocks, setting clock sources, and managing interrupts. It also
 * includes reserved spaces for future expansion, ensuring compatibility
 * with potential future updates. The structure supports operations for
 * setting, clearing, and toggling register values, providing a flexible
 ...
 * @param EM01GRPCCLKCTRL EM01 Peripheral Group C Clock Control.
 ...
 * @param EM01GRPCCLKCTRL_SET EM01 Peripheral Group C Clock Control.
 ...
 * @param WDOG1CLKCTRL_SET Watchdog1 Clock Control.
 * @param RESERVED40 Reserved for future use.
 * @param EUSART0CLKCTRL_SET EUSART0 Clock Control.
 * @param RESERVED41 Reserved for future use.
 * @param SYSRTC0CLKCTRL_SET System RTC0 Clock Control.
 * @param RESERVED42 Reserved for future use.
 * @param VDAC0CLKCTRL_SET VDAC0 Clock Control.
 * @param RESERVED43 Reserved for future use.
 * @param PCNT0CLKCTRL_SET Pulse counter 0 Clock Control.
 ...
 * @param VDAC1CLKCTRL_SET VDAC1 Clock Control.
 ...
 * @param EM01GRPCCLKCTRL_CLR EM01 Peripheral Group C Clock Control.
 ...
 * @param WDOG1CLKCTRL_CLR Watchdog1 Clock Control.
 * @param RESERVED64 Reserved for future use.
 * @param EUSART0CLKCTRL_CLR EUSART0 Clock Control.
 * @param RESERVED65 Reserved for future use.
 * @param SYSRTC0CLKCTRL_CLR System RTC0 Clock Control.
 * @param RESERVED66 Reserved for future use.
 * @param VDAC0CLKCTRL_CLR VDAC0 Clock Control.
 * @param RESERVED67 Reserved for future use.
 * @param PCNT0CLKCTRL_CLR Pulse counter 0 Clock Control.
 ...
 * @param VDAC1CLKCTRL_CLR VDAC1 Clock Control.
 ...
 * @param RESERVED79 Reserved for future use.
 * @param EXPORTCLKCTRL_TGL Export Clock Control.
 * @param RESERVED80 Reserved for future use.
 * @param DPLLREFCLKCTRL_TGL Digital PLL Reference Clock Control.
 * @param RESERVED81 Reserved for future use.
 * @param EM01GRPACLKCTRL_TGL EM01 Peripheral Group A Clock Control.
 * @param RESERVED82 Reserved for future use.
 * @param EM01GRPCCLKCTRL_TGL EM01 Peripheral Group C Clock Control.
 * @param RESERVED83 Reserved for future use.
 * @param EM23GRPACLKCTRL_TGL EM23 Peripheral Group A Clock Control.
 * @param RESERVED84 Reserved for future use.
 * @param EM4GRPACLKCTRL_TGL EM4 Peripheral Group A Clock Control.
 * @param RESERVED85 Reserved for future use.
 * @param IADCCLKCTRL_TGL IADC Clock Control.
 * @param RESERVED86 Reserved for future use.
 * @param WDOG0CLKCTRL_TGL Watchdog0 Clock Control.
 * @param RESERVED87 Reserved for future use.
 * @param WDOG1CLKCTRL_TGL Watchdog1 Clock Control.
 * @param RESERVED88 Reserved for future use.
 * @param EUSART0CLKCTRL_TGL EUSART0 Clock Control.
 * @param RESERVED89 Reserved for future use.
 * @param SYSRTC0CLKCTRL_TGL System RTC0 Clock Control.
 * @param RESERVED90 Reserved for future use.
 * @param VDAC0CLKCTRL_TGL VDAC0 Clock Control.
 * @param RESERVED91 Reserved for future use.
 * @param PCNT0CLKCTRL_TGL Pulse counter 0 Clock Control.
 * @param RESERVED92 Reserved for future use.
 * @param RADIOCLKCTRL_TGL Radio Clock Control.
 * @param RESERVED93 Reserved for future use.
 * @param VDAC1CLKCTRL_TGL VDAC1 Clock Control.
 * @param RESERVED94 Reserved for future use.
 ******************************************************************************/

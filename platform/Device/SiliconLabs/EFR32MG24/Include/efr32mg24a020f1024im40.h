 ...
 * interrupts. It includes negative values for processor exceptions like
 * Non-Maskable Interrupt and Hard Fault, and positive values for
 * peripheral interrupts such as SMU_SECURE and TIMER0. This enumeration
 * is used to identify and manage different interrupt sources within the

 ...
 * such as `NonMaskableInt_IRQn` and `HardFault_IRQn`, and positive
 * values for peripheral interrupts, such as `TIMER0_IRQn` and
 * `USART0_RX_IRQn`. This enumeration is used to identify and manage the
 * various interrupt sources within the system, allowing for efficient

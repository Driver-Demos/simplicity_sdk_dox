 ...
 * System (PRS) of the EFR32MG24 microcontroller. It contains a single
 ...
 * of a larger system that manages the routing of signals between
 * peripherals without CPU intervention, enhancing the efficiency of the
 ...
 * the EFR32MG24 microcontroller. It contains a single member, `CTRL`,
 * which is a 32-bit register used to control the behavior of a
 * synchronous channel in the PRS. This structure is part of a larger
 * system that manages the routing of signals between peripherals without
 * CPU intervention, allowing for efficient and low-latency communication
...
/***************************************************************************//**
 * @brief The `PRS_TypeDef` is a comprehensive structure representing the
 * Peripheral Reflex System (PRS) for the EFR32MG24 microcontroller. It
 * includes a variety of registers for managing asynchronous and
 * synchronous channel operations, software pulse and level controls, and
 * numerous consumer registers for different peripherals. The structure
 * is designed to facilitate the configuration and control of the PRS,
 * allowing for efficient signal routing and event handling across the
 * microcontroller's peripherals. It includes multiple reserved fields
 * for future expansion, ensuring adaptability to future hardware
 * updates.
 *
 * @param IPVERSION PRS IPVERSION.
 ...
 * @param CONSUMER_CMU_CALDN CALDN consumer register.
 * @param CONSUMER_CMU_CALUP CALUP Consumer register.
 * @param CONSUMER_EUSART0_CLK CLK consumer register.
 * @param CONSUMER_EUSART0_RX RX Consumer register.
 * @param CONSUMER_EUSART0_TRIGGER TRIGGER Consumer register.
 * @param CONSUMER_EUSART1_CLK CLK consumer register.
 * @param CONSUMER_EUSART1_RX RX Consumer register.
 * @param CONSUMER_EUSART1_TRIGGER TRIGGER Consumer register.
 * @param RESERVED1 Reserved for future use.
 * @param CONSUMER_IADC0_SCANTRIGGER SCAN consumer register.
 * @param CONSUMER_IADC0_SINGLETRIGGER SINGLE Consumer register.
 * @param CONSUMER_LDMAXBAR_DMAREQ0 DMAREQ0 consumer register.
 * @param CONSUMER_LDMAXBAR_DMAREQ1 DMAREQ1 Consumer register.
 * @param CONSUMER_LETIMER0_CLEAR CLEAR consumer register.
 * @param CONSUMER_LETIMER0_START START Consumer register.
 * @param CONSUMER_LETIMER0_STOP STOP Consumer register.
 * @param CONSUMER_MODEM_DIN DIN consumer register.
 * @param CONSUMER_MODEM_PAEN PAEN Consumer register.
 * @param CONSUMER_PCNT0_S0IN S0IN consumer register.
 * @param CONSUMER_PCNT0_S1IN S1IN Consumer register.
 * @param RESERVED2 Reserved for future use.
 * @param CONSUMER_RAC_CLR CLR consumer register.
 * @param CONSUMER_RAC_CTIIN0 CTI Consumer register.
 * @param CONSUMER_RAC_CTIIN1 CTI Consumer register.
 * @param CONSUMER_RAC_CTIIN2 CTI Consumer register.
 * @param CONSUMER_RAC_CTIIN3 CTI Consumer register.
 * @param CONSUMER_RAC_FORCETX FORCETX Consumer register.
 * @param CONSUMER_RAC_RXDIS RXDIS Consumer register.
 * @param CONSUMER_RAC_RXEN RXEN Consumer register.
 * @param CONSUMER_RAC_TXEN TXEN Consumer register.
 * @param CONSUMER_SETAMPER_TAMPERSRC25 TAMPERSRC25 consumer register.
 * @param CONSUMER_SETAMPER_TAMPERSRC26 TAMPERSRC26 Consumer register.
 * @param CONSUMER_SETAMPER_TAMPERSRC27 TAMPERSRC27 Consumer register.
 * @param CONSUMER_SETAMPER_TAMPERSRC28 TAMPERSRC28 Consumer register.
 * @param CONSUMER_SETAMPER_TAMPERSRC29 TAMPERSRC29 Consumer register.
 * @param CONSUMER_SETAMPER_TAMPERSRC30 TAMPERSRC30 Consumer register.
 * @param CONSUMER_SETAMPER_TAMPERSRC31 TAMPERSRC31 Consumer register.
 * @param CONSUMER_SYSRTC0_IN0 IN0 consumer register.
 * @param CONSUMER_SYSRTC0_IN1 IN1 Consumer register.
 * @param CONSUMER_HFXO0_OSCREQ OSCREQ consumer register.
 * @param CONSUMER_HFXO0_TIMEOUT TIMEOUT Consumer register.
 ...
 * @param CONSUMER_TIMER0_CC0 CC0 consumer register.
 * @param CONSUMER_TIMER0_CC1 CC1 Consumer register.
 * @param CONSUMER_TIMER0_CC2 CC2 Consumer register.
 * @param CONSUMER_TIMER0_DTI DTI Consumer register.
 * @param CONSUMER_TIMER0_DTIFS1 DTI Consumer register.
 * @param CONSUMER_TIMER0_DTIFS2 DTI Consumer register.
 * @param CONSUMER_TIMER1_CC0 CC0 consumer register.
 * @param CONSUMER_TIMER1_CC1 CC1 Consumer register.
 * @param CONSUMER_TIMER1_CC2 CC2 Consumer register.
 * @param CONSUMER_TIMER1_DTI DTI Consumer register.
 * @param CONSUMER_TIMER1_DTIFS1 DTI Consumer register.
 * @param CONSUMER_TIMER1_DTIFS2 DTI Consumer register.
 * @param CONSUMER_TIMER2_CC0 CC0 consumer register.
 * @param CONSUMER_TIMER2_CC1 CC1 Consumer register.
 * @param CONSUMER_TIMER2_CC2 CC2 Consumer register.
 * @param CONSUMER_TIMER2_DTI DTI Consumer register.
 * @param CONSUMER_TIMER2_DTIFS1 DTI Consumer register.
 * @param CONSUMER_TIMER2_DTIFS2 DTI Consumer register.
 * @param CONSUMER_TIMER3_CC0 CC0 consumer register.
 * @param CONSUMER_TIMER3_CC1 CC1 Consumer register.
 * @param CONSUMER_TIMER3_CC2 CC2 Consumer register.
 * @param CONSUMER_TIMER3_DTI DTI Consumer register.
 * @param CONSUMER_TIMER3_DTIFS1 DTI Consumer register.
 * @param CONSUMER_TIMER3_DTIFS2 DTI Consumer register.
 * @param CONSUMER_TIMER4_CC0 CC0 consumer register.
 * @param CONSUMER_TIMER4_CC1 CC1 Consumer register.
 * @param CONSUMER_TIMER4_CC2 CC2 Consumer register.
 * @param CONSUMER_TIMER4_DTI DTI Consumer register.
 * @param CONSUMER_TIMER4_DTIFS1 DTI Consumer register.
 * @param CONSUMER_TIMER4_DTIFS2 DTI Consumer register.
 * @param CONSUMER_USART0_CLK CLK consumer register.
 * @param CONSUMER_USART0_IR IR Consumer register.
 * @param CONSUMER_USART0_RX RX Consumer register.
 * @param CONSUMER_USART0_TRIGGER TRIGGER Consumer register.
 * @param RESERVED3 Reserved for future use.
 * @param CONSUMER_VDAC0_ASYNCTRIGCH0 ASYNCTRIG consumer register.
 * @param CONSUMER_VDAC0_ASYNCTRIGCH1 ASYNCTRIG Consumer register.
 * @param CONSUMER_VDAC0_SYNCTRIGCH0 SYNCTRIG Consumer register.
 * @param CONSUMER_VDAC0_SYNCTRIGCH1 SYNCTRIG Consumer register.
 * @param CONSUMER_VDAC1_ASYNCTRIGCH0 ASYNCTRIG consumer register.
 * @param CONSUMER_VDAC1_ASYNCTRIGCH1 ASYNCTRIG Consumer register.
 * @param CONSUMER_VDAC1_SYNCTRIGCH0 SYNCTRIG Consumer register.
 * @param CONSUMER_VDAC1_SYNCTRIGCH1 SYNCTRIG Consumer register.
 * @param CONSUMER_WDOG0_SRC0 SRC0 consumer register.
 * @param CONSUMER_WDOG0_SRC1 SRC1 Consumer register.
 * @param CONSUMER_WDOG1_SRC0 SRC0 consumer register.
 * @param CONSUMER_WDOG1_SRC1 SRC1 Consumer register.
 * @param RESERVED4 Reserved for future use.
 * @param RESERVED5 Reserved for future use.
 * @param IPVERSION_SET PRS IPVERSION.
 ...
 * @param CONSUMER_CMU_CALDN_SET CALDN consumer register.
 * @param CONSUMER_CMU_CALUP_SET CALUP Consumer register.
 * @param CONSUMER_EUSART0_CLK_SET CLK consumer register.
 * @param CONSUMER_EUSART0_RX_SET RX Consumer register.
 * @param CONSUMER_EUSART0_TRIGGER_SET TRIGGER Consumer register.
 * @param CONSUMER_EUSART1_CLK_SET CLK consumer register.
 * @param CONSUMER_EUSART1_RX_SET RX Consumer register.
 * @param CONSUMER_EUSART1_TRIGGER_SET TRIGGER Consumer register.
 * @param RESERVED7 Reserved for future use.
 * @param CONSUMER_IADC0_SCANTRIGGER_SET SCAN consumer register.
 * @param CONSUMER_IADC0_SINGLETRIGGER_SET SINGLE Consumer register.
 * @param CONSUMER_LDMAXBAR_DMAREQ0_SET DMAREQ0 consumer register.
 * @param CONSUMER_LDMAXBAR_DMAREQ1_SET DMAREQ1 Consumer register.
 * @param CONSUMER_LETIMER0_CLEAR_SET CLEAR consumer register.
 * @param CONSUMER_LETIMER0_START_SET START Consumer register.
 * @param CONSUMER_LETIMER0_STOP_SET STOP Consumer register.
 * @param CONSUMER_MODEM_DIN_SET DIN consumer register.
 * @param CONSUMER_MODEM_PAEN_SET PAEN Consumer register.
 * @param CONSUMER_PCNT0_S0IN_SET S0IN consumer register.
 * @param CONSUMER_PCNT0_S1IN_SET S1IN Consumer register.
 * @param RESERVED8 Reserved for future use.
 * @param CONSUMER_RAC_CLR_SET CLR consumer register.
 * @param CONSUMER_RAC_CTIIN0_SET CTI Consumer register.
 * @param CONSUMER_RAC_CTIIN1_SET CTI Consumer register.
 * @param CONSUMER_RAC_CTIIN2_SET CTI Consumer register.
 * @param CONSUMER_RAC_CTIIN3_SET CTI Consumer register.
 * @param CONSUMER_RAC_FORCETX_SET FORCETX Consumer register.
 * @param CONSUMER_RAC_RXDIS_SET RXDIS Consumer register.
 * @param CONSUMER_RAC_RXEN_SET RXEN Consumer register.
 * @param CONSUMER_RAC_TXEN_SET TXEN Consumer register.
 * @param CONSUMER_SETAMPER_TAMPERSRC25_SET TAMPERSRC25 consumer register.
 * @param CONSUMER_SETAMPER_TAMPERSRC26_SET TAMPERSRC26 Consumer register.
 * @param CONSUMER_SETAMPER_TAMPERSRC27_SET TAMPERSRC27 Consumer register.
 * @param CONSUMER_SETAMPER_TAMPERSRC28_SET TAMPERSRC28 Consumer register.
 * @param CONSUMER_SETAMPER_TAMPERSRC29_SET TAMPERSRC29 Consumer register.
 * @param CONSUMER_SETAMPER_TAMPERSRC30_SET TAMPERSRC30 Consumer register.
 * @param CONSUMER_SETAMPER_TAMPERSRC31_SET TAMPERSRC31 Consumer register.
 * @param CONSUMER_SYSRTC0_IN0_SET IN0 consumer register.
 * @param CONSUMER_SYSRTC0_IN1_SET IN1 Consumer register.
 * @param CONSUMER_HFXO0_OSCREQ_SET OSCREQ consumer register.
 * @param CONSUMER_HFXO0_TIMEOUT_SET TIMEOUT Consumer register.
 ...
 * @param CONSUMER_TIMER0_CC0_SET CC0 consumer register.
 * @param CONSUMER_TIMER0_CC1_SET CC1 Consumer register.
 * @param CONSUMER_TIMER0_CC2_SET CC2 Consumer register.
 * @param CONSUMER_TIMER0_DTI_SET DTI Consumer register.
 * @param CONSUMER_TIMER0_DTIFS1_SET DTI Consumer register.
 * @param CONSUMER_TIMER0_DTIFS2_SET DTI Consumer register.
 * @param CONSUMER_TIMER1_CC0_SET CC0 consumer register.
 * @param CONSUMER_TIMER1_CC1_SET CC1 Consumer register.
 * @param CONSUMER_TIMER1_CC2_SET CC2 Consumer register.
 * @param CONSUMER_TIMER1_DTI_SET DTI Consumer register.
 * @param CONSUMER_TIMER1_DTIFS1_SET DTI Consumer register.
 * @param CONSUMER_TIMER1_DTIFS2_SET DTI Consumer register.
 * @param CONSUMER_TIMER2_CC0_SET CC0 consumer register.
 * @param CONSUMER_TIMER2_CC1_SET CC1 Consumer register.
 * @param CONSUMER_TIMER2_CC2_SET CC2 Consumer register.
 * @param CONSUMER_TIMER2_DTI_SET DTI Consumer register.
 * @param CONSUMER_TIMER2_DTIFS1_SET DTI Consumer register.
 * @param CONSUMER_TIMER2_DTIFS2_SET DTI Consumer register.
 * @param CONSUMER_TIMER3_CC0_SET CC0 consumer register.
 * @param CONSUMER_TIMER3_CC1_SET CC1 Consumer register.
 * @param CONSUMER_TIMER3_CC2_SET CC2 Consumer register.
 * @param CONSUMER_TIMER3_DTI_SET DTI Consumer register.
 * @param CONSUMER_TIMER3_DTIFS1_SET DTI Consumer register.
 * @param CONSUMER_TIMER3_DTIFS2_SET DTI Consumer register.
 * @param CONSUMER_TIMER4_CC0_SET CC0 consumer register.
 * @param CONSUMER_TIMER4_CC1_SET CC1 Consumer register.
 * @param CONSUMER_TIMER4_CC2_SET CC2 Consumer register.
 * @param CONSUMER_TIMER4_DTI_SET DTI Consumer register.
 * @param CONSUMER_TIMER4_DTIFS1_SET DTI Consumer register.
 * @param CONSUMER_TIMER4_DTIFS2_SET DTI Consumer register.
 * @param CONSUMER_USART0_CLK_SET CLK consumer register.
 * @param CONSUMER_USART0_IR_SET IR Consumer register.
 * @param CONSUMER_USART0_RX_SET RX Consumer register.
 * @param CONSUMER_USART0_TRIGGER_SET TRIGGER Consumer register.
 * @param RESERVED9 Reserved for future use.
 * @param CONSUMER_VDAC0_ASYNCTRIGCH0_SET ASYNCTRIG consumer register.
 * @param CONSUMER_VDAC0_ASYNCTRIGCH1_SET ASYNCTRIG Consumer register.
 * @param CONSUMER_VDAC0_SYNCTRIGCH0_SET SYNCTRIG Consumer register.
 * @param CONSUMER_VDAC0_SYNCTRIGCH1_SET SYNCTRIG Consumer register.
 * @param CONSUMER_VDAC1_ASYNCTRIGCH0_SET ASYNCTRIG consumer register.
 * @param CONSUMER_VDAC1_ASYNCTRIGCH1_SET ASYNCTRIG Consumer register.
 * @param CONSUMER_VDAC1_SYNCTRIGCH0_SET SYNCTRIG Consumer register.
 * @param CONSUMER_VDAC1_SYNCTRIGCH1_SET SYNCTRIG Consumer register.
 * @param CONSUMER_WDOG0_SRC0_SET SRC0 consumer register.
 * @param CONSUMER_WDOG0_SRC1_SET SRC1 Consumer register.
 * @param CONSUMER_WDOG1_SRC0_SET SRC0 consumer register.
 * @param CONSUMER_WDOG1_SRC1_SET SRC1 Consumer register.
 * @param RESERVED10 Reserved for future use.
 * @param RESERVED11 Reserved for future use.
 * @param IPVERSION_CLR PRS IPVERSION.
 ...
 * @param CONSUMER_CMU_CALDN_CLR CALDN consumer register.
 * @param CONSUMER_CMU_CALUP_CLR CALUP Consumer register.
 * @param CONSUMER_EUSART0_CLK_CLR CLK consumer register.
 * @param CONSUMER_EUSART0_RX_CLR RX Consumer register.
 * @param CONSUMER_EUSART0_TRIGGER_CLR TRIGGER Consumer register.
 * @param CONSUMER_EUSART1_CLK_CLR CLK consumer register.
 * @param CONSUMER_EUSART1_RX_CLR RX Consumer register.
 * @param CONSUMER_EUSART1_TRIGGER_CLR TRIGGER Consumer register.
 * @param RESERVED13 Reserved for future use.
 * @param CONSUMER_IADC0_SCANTRIGGER_CLR SCAN consumer register.
 * @param CONSUMER_IADC0_SINGLETRIGGER_CLR SINGLE Consumer register.
 * @param CONSUMER_LDMAXBAR_DMAREQ0_CLR DMAREQ0 consumer register.
 * @param CONSUMER_LDMAXBAR_DMAREQ1_CLR DMAREQ1 Consumer register.
 * @param CONSUMER_LETIMER0_CLEAR_CLR CLEAR consumer register.
 * @param CONSUMER_LETIMER0_START_CLR START Consumer register.
 * @param CONSUMER_LETIMER0_STOP_CLR STOP Consumer register.
 * @param CONSUMER_MODEM_DIN_CLR DIN consumer register.
 * @param CONSUMER_MODEM_PAEN_CLR PAEN Consumer register.
 * @param CONSUMER_PCNT0_S0IN_CLR S0IN consumer register.
 * @param CONSUMER_PCNT0_S1IN_CLR S1IN Consumer register.
 * @param RESERVED14 Reserved for future use.
 * @param CONSUMER_RAC_CLR_CLR CLR consumer register.
 * @param CONSUMER_RAC_CTIIN0_CLR CTI Consumer register.
 * @param CONSUMER_RAC_CTIIN1_CLR CTI Consumer register.
 * @param CONSUMER_RAC_CTIIN2_CLR CTI Consumer register.
 * @param CONSUMER_RAC_CTIIN3_CLR CTI Consumer register.
 * @param CONSUMER_RAC_FORCETX_CLR FORCETX Consumer register.
 * @param CONSUMER_RAC_RXDIS_CLR RXDIS Consumer register.
 * @param CONSUMER_RAC_RXEN_CLR RXEN Consumer register.
 * @param CONSUMER_RAC_TXEN_CLR TXEN Consumer register.
 * @param CONSUMER_SETAMPER_TAMPERSRC25_CLR TAMPERSRC25 consumer register.
 * @param CONSUMER_SETAMPER_TAMPERSRC26_CLR TAMPERSRC26 Consumer register.
 * @param CONSUMER_SETAMPER_TAMPERSRC27_CLR TAMPERSRC27 Consumer register.
 * @param CONSUMER_SETAMPER_TAMPERSRC28_CLR TAMPERSRC28 Consumer register.
 * @param CONSUMER_SETAMPER_TAMPERSRC29_CLR TAMPERSRC29 Consumer register.
 * @param CONSUMER_SETAMPER_TAMPERSRC30_CLR TAMPERSRC30 Consumer register.
 * @param CONSUMER_SETAMPER_TAMPERSRC31_CLR TAMPERSRC31 Consumer register.
 * @param CONSUMER_SYSRTC0_IN0_CLR IN0 consumer register.
 * @param CONSUMER_SYSRTC0_IN1_CLR IN1 Consumer register.
 * @param CONSUMER_HFXO0_OSCREQ_CLR OSCREQ consumer register.
 * @param CONSUMER_HFXO0_TIMEOUT_CLR TIMEOUT Consumer register.
 ...
 * @param CONSUMER_TIMER0_CC0_CLR CC0 consumer register.
 * @param CONSUMER_TIMER0_CC1_CLR CC1 Consumer register.
 * @param CONSUMER_TIMER0_CC2_CLR CC2 Consumer register.
 * @param CONSUMER_TIMER0_DTI_CLR DTI Consumer register.
 * @param CONSUMER_TIMER0_DTIFS1_CLR DTI Consumer register.
 * @param CONSUMER_TIMER0_DTIFS2_CLR DTI Consumer register.
 * @param CONSUMER_TIMER1_CC0_CLR CC0 consumer register.
 * @param CONSUMER_TIMER1_CC1_CLR CC1 Consumer register.
 * @param CONSUMER_TIMER1_CC2_CLR CC2 Consumer register.
 * @param CONSUMER_TIMER1_DTI_CLR DTI Consumer register.
 * @param CONSUMER_TIMER1_DTIFS1_CLR DTI Consumer register.
 * @param CONSUMER_TIMER1_DTIFS2_CLR DTI Consumer register.
 * @param CONSUMER_TIMER2_CC0_CLR CC0 consumer register.
 * @param CONSUMER_TIMER2_CC1_CLR CC1 Consumer register.
 * @param CONSUMER_TIMER2_CC2_CLR CC2 Consumer register.
 * @param CONSUMER_TIMER2_DTI_CLR DTI Consumer register.
 * @param CONSUMER_TIMER2_DTIFS1_CLR DTI Consumer register.
 * @param CONSUMER_TIMER2_DTIFS2_CLR DTI Consumer register.
 * @param CONSUMER_TIMER3_CC0_CLR CC0 consumer register.
 * @param CONSUMER_TIMER3_CC1_CLR CC1 Consumer register.
 * @param CONSUMER_TIMER3_CC2_CLR CC2 Consumer register.
 * @param CONSUMER_TIMER3_DTI_CLR DTI Consumer register.
 * @param CONSUMER_TIMER3_DTIFS1_CLR DTI Consumer register.
 * @param CONSUMER_TIMER3_DTIFS2_CLR DTI Consumer register.
 * @param CONSUMER_TIMER4_CC0_CLR CC0 consumer register.
 * @param CONSUMER_TIMER4_CC1_CLR CC1 Consumer register.
 * @param CONSUMER_TIMER4_CC2_CLR CC2 Consumer register.
 * @param CONSUMER_TIMER4_DTI_CLR DTI Consumer register.
 * @param CONSUMER_TIMER4_DTIFS1_CLR DTI Consumer register.
 * @param CONSUMER_TIMER4_DTIFS2_CLR DTI Consumer register.
 * @param CONSUMER_USART0_CLK_CLR CLK consumer register.
 * @param CONSUMER_USART0_IR_CLR IR Consumer register.
 * @param CONSUMER_USART0_RX_CLR RX Consumer register.
 * @param CONSUMER_USART0_TRIGGER_CLR TRIGGER Consumer register.
 * @param RESERVED15 Reserved for future use.
 * @param CONSUMER_VDAC0_ASYNCTRIGCH0_CLR ASYNCTRIG consumer register.
 * @param CONSUMER_VDAC0_ASYNCTRIGCH1_CLR ASYNCTRIG Consumer register.
 * @param CONSUMER_VDAC0_SYNCTRIGCH0_CLR SYNCTRIG Consumer register.
 * @param CONSUMER_VDAC0_SYNCTRIGCH1_CLR SYNCTRIG Consumer register.
 * @param CONSUMER_VDAC1_ASYNCTRIGCH0_CLR ASYNCTRIG consumer register.
 * @param CONSUMER_VDAC1_ASYNCTRIGCH1_CLR ASYNCTRIG Consumer register.
 * @param CONSUMER_VDAC1_SYNCTRIGCH0_CLR SYNCTRIG Consumer register.
 * @param CONSUMER_VDAC1_SYNCTRIGCH1_CLR SYNCTRIG Consumer register.
 * @param CONSUMER_WDOG0_SRC0_CLR SRC0 consumer register.
 * @param CONSUMER_WDOG0_SRC1_CLR SRC1 Consumer register.
 * @param CONSUMER_WDOG1_SRC0_CLR SRC0 consumer register.
 * @param CONSUMER_WDOG1_SRC1_CLR SRC1 Consumer register.
 * @param RESERVED16 Reserved for future use.
 * @param RESERVED17 Reserved for future use.
 * @param IPVERSION_TGL PRS IPVERSION.
 ...
 * @param CONSUMER_CMU_CALDN_TGL CALDN consumer register.
 * @param CONSUMER_CMU_CALUP_TGL CALUP Consumer register.
 * @param CONSUMER_EUSART0_CLK_TGL CLK consumer register.
 * @param CONSUMER_EUSART0_RX_TGL RX Consumer register.
 * @param CONSUMER_EUSART0_TRIGGER_TGL TRIGGER Consumer register.
 * @param CONSUMER_EUSART1_CLK_TGL CLK consumer register.
 * @param CONSUMER_EUSART1_RX_TGL RX Consumer register.
 * @param CONSUMER_EUSART1_TRIGGER_TGL TRIGGER Consumer register.
 * @param RESERVED19 Reserved for future use.
 * @param CONSUMER_IADC0_SCANTRIGGER_TGL SCAN consumer register.
 * @param CONSUMER_IADC0_SINGLETRIGGER_TGL SINGLE Consumer register.
 * @param CONSUMER_LDMAXBAR_DMAREQ0_TGL DMAREQ0 consumer register.
 * @param CONSUMER_LDMAXBAR_DMAREQ1_TGL DMAREQ1 Consumer register.
 * @param CONSUMER_LETIMER0_CLEAR_TGL CLEAR consumer register.
 * @param CONSUMER_LETIMER0_START_TGL START Consumer register.
 * @param CONSUMER_LETIMER0_STOP_TGL STOP Consumer register.
 * @param CONSUMER_MODEM_DIN_TGL DIN consumer register.
 * @param CONSUMER_MODEM_PAEN_TGL PAEN Consumer register.
 * @param CONSUMER_PCNT0_S0IN_TGL S0IN consumer register.
 * @param CONSUMER_PCNT0_S1IN_TGL S1IN Consumer register.
 * @param RESERVED20 Reserved for future use.
 * @param CONSUMER_RAC_CLR_TGL CLR consumer register.
 * @param CONSUMER_RAC_CTIIN0_TGL CTI Consumer register.
 * @param CONSUMER_RAC_CTIIN1_TGL CTI Consumer register.
 * @param CONSUMER_RAC_CTIIN2_TGL CTI Consumer register.
 * @param CONSUMER_RAC_CTIIN3_TGL CTI Consumer register.
 * @param CONSUMER_RAC_FORCETX_TGL FORCETX Consumer register.
 * @param CONSUMER_RAC_RXDIS_TGL RXDIS Consumer register.
 * @param CONSUMER_RAC_RXEN_TGL RXEN Consumer register.
 * @param CONSUMER_RAC_TXEN_TGL TXEN Consumer register.
 * @param CONSUMER_SETAMPER_TAMPERSRC25_TGL TAMPERSRC25 consumer register.
 * @param CONSUMER_SETAMPER_TAMPERSRC26_TGL TAMPERSRC26 Consumer register.
 * @param CONSUMER_SETAMPER_TAMPERSRC27_TGL TAMPERSRC27 Consumer register.
 * @param CONSUMER_SETAMPER_TAMPERSRC28_TGL TAMPERSRC28 Consumer register.
 * @param CONSUMER_SETAMPER_TAMPERSRC29_TGL TAMPERSRC29 Consumer register.
 * @param CONSUMER_SETAMPER_TAMPERSRC30_TGL TAMPERSRC30 Consumer register.
 * @param CONSUMER_SETAMPER_TAMPERSRC31_TGL TAMPERSRC31 Consumer register.
 * @param CONSUMER_SYSRTC0_IN0_TGL IN0 consumer register.
 * @param CONSUMER_SYSRTC0_IN1_TGL IN1 Consumer register.
 * @param CONSUMER_HFXO0_OSCREQ_TGL OSCREQ consumer register.
 * @param CONSUMER_HFXO0_TIMEOUT_TGL TIMEOUT Consumer register.
 ...
 * @param CONSUMER_TIMER0_CC0_TGL CC0 consumer register.
 * @param CONSUMER_TIMER0_CC1_TGL CC1 Consumer register.
 * @param CONSUMER_TIMER0_CC2_TGL CC2 Consumer register.
 * @param CONSUMER_TIMER0_DTI_TGL DTI Consumer register.
 * @param CONSUMER_TIMER0_DTIFS1_TGL DTI Consumer register.
 * @param CONSUMER_TIMER0_DTIFS2_TGL DTI Consumer register.
 * @param CONSUMER_TIMER1_CC0_TGL CC0 consumer register.
 * @param CONSUMER_TIMER1_CC1_TGL CC1 Consumer register.
 * @param CONSUMER_TIMER1_CC2_TGL CC2 Consumer register.
 * @param CONSUMER_TIMER1_DTI_TGL DTI Consumer register.
 * @param CONSUMER_TIMER1_DTIFS1_TGL DTI Consumer register.
 * @param CONSUMER_TIMER1_DTIFS2_TGL DTI Consumer register.
 * @param CONSUMER_TIMER2_CC0_TGL CC0 consumer register.
 * @param CONSUMER_TIMER2_CC1_TGL CC1 Consumer register.
 * @param CONSUMER_TIMER2_CC2_TGL CC2 Consumer register.
 * @param CONSUMER_TIMER2_DTI_TGL DTI Consumer register.
 * @param CONSUMER_TIMER2_DTIFS1_TGL DTI Consumer register.
 * @param CONSUMER_TIMER2_DTIFS2_TGL DTI Consumer register.
 * @param CONSUMER_TIMER3_CC0_TGL CC0 consumer register.
 * @param CONSUMER_TIMER3_CC1_TGL CC1 Consumer register.
 * @param CONSUMER_TIMER3_CC2_TGL CC2 Consumer register.
 * @param CONSUMER_TIMER3_DTI_TGL DTI Consumer register.
 * @param CONSUMER_TIMER3_DTIFS1_TGL DTI Consumer register.
 * @param CONSUMER_TIMER3_DTIFS2_TGL DTI Consumer register.
 * @param CONSUMER_TIMER4_CC0_TGL CC0 consumer register.
 * @param CONSUMER_TIMER4_CC1_TGL CC1 Consumer register.
 * @param CONSUMER_TIMER4_CC2_TGL CC2 Consumer register.
 * @param CONSUMER_TIMER4_DTI_TGL DTI Consumer register.
 * @param CONSUMER_TIMER4_DTIFS1_TGL DTI Consumer register.
 * @param CONSUMER_TIMER4_DTIFS2_TGL DTI Consumer register.
 * @param CONSUMER_USART0_CLK_TGL CLK consumer register.
 * @param CONSUMER_USART0_IR_TGL IR Consumer register.
 * @param CONSUMER_USART0_RX_TGL RX Consumer register.
 * @param CONSUMER_USART0_TRIGGER_TGL TRIGGER Consumer register.
 * @param RESERVED21 Reserved for future use.
 * @param CONSUMER_VDAC0_ASYNCTRIGCH0_TGL ASYNCTRIG consumer register.
 * @param CONSUMER_VDAC0_ASYNCTRIGCH1_TGL ASYNCTRIG Consumer register.
 * @param CONSUMER_VDAC0_SYNCTRIGCH0_TGL SYNCTRIG Consumer register.
 * @param CONSUMER_VDAC0_SYNCTRIGCH1_TGL SYNCTRIG Consumer register.
 * @param CONSUMER_VDAC1_ASYNCTRIGCH0_TGL ASYNCTRIG consumer register.
 * @param CONSUMER_VDAC1_ASYNCTRIGCH1_TGL ASYNCTRIG Consumer register.
 * @param CONSUMER_VDAC1_SYNCTRIGCH0_TGL SYNCTRIG Consumer register.
 * @param CONSUMER_VDAC1_SYNCTRIGCH1_TGL SYNCTRIG Consumer register.
 * @param CONSUMER_WDOG0_SRC0_TGL SRC0 consumer register.
 * @param CONSUMER_WDOG0_SRC1_TGL SRC1 Consumer register.
 * @param CONSUMER_WDOG1_SRC0_TGL SRC0 consumer register.
 * @param CONSUMER_WDOG1_SRC1_TGL SRC1 Consumer register.

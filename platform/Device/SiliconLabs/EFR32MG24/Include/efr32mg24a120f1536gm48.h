 ...
 * and positive values for peripheral interrupts, allowing the system to
 * handle a wide range of interrupt sources. This enumeration is crucial
 * for configuring and managing interrupt handling in embedded systems
 * using the EFR32MG24 microcontroller.
 *

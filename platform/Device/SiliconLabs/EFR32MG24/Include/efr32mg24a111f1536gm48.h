 ...
 * for both Cortex-M processor exceptions and EFR32MG24 peripheral
 * interrupts. It includes negative values for processor exceptions such
 * as Non-Maskable Interrupt and Hard Fault, and positive values for
 * peripheral interrupts like SMU_SECURE and TIMER0. This enumeration is
 * used to identify and manage different interrupt sources in the system,
 * allowing for efficient interrupt handling and prioritization.
 *
 ...
 * Interrupt with a value of 2.
 * @param EMU_IRQn Represents the EFR32 EMU Interrupt with a value of 3.
 * @param TIMER0_IRQn Represents the EFR32 TIMER0 Interrupt with a value of 4.
 * @param TIMER1_IRQn Represents the EFR32 TIMER1 Interrupt with a value of 5.
 * @param TIMER2_IRQn Represents the EFR32 TIMER2 Interrupt with a value of 6.
 * @param TIMER3_IRQn Represents the EFR32 TIMER3 Interrupt with a value of 7.
 * @param TIMER4_IRQn Represents the EFR32 TIMER4 Interrupt with a value of 8.
 ...
 * of 10.
 * @param EUSART0_RX_IRQn Represents the EFR32 EUSART0_RX Interrupt with a value
 * of 11.
 * @param EUSART0_TX_IRQn Represents the EFR32 EUSART0_TX Interrupt with a value
 * of 12.
 * @param EUSART1_RX_IRQn Represents the EFR32 EUSART1_RX Interrupt with a value
 * of 13.
 * @param EUSART1_TX_IRQn Represents the EFR32 EUSART1_TX Interrupt with a value
 * of 14.
 * @param ICACHE0_IRQn Represents the EFR32 ICACHE0 Interrupt with a value of
 * 16.
 * @param BURTC_IRQn Represents the EFR32 BURTC Interrupt with a value of 17.
 * @param LETIMER0_IRQn Represents the EFR32 LETIMER0 Interrupt with a value of
 * 18.
 * @param SYSCFG_IRQn Represents the EFR32 SYSCFG Interrupt with a value of 19.
 * @param MPAHBRAM_IRQn Represents the EFR32 MPAHBRAM Interrupt with a value of
 * 20.
 ...
 * @param AGC_IRQn Represents the EFR32 AGC Interrupt with a value of 30.
 * @param BUFC_IRQn Represents the EFR32 BUFC Interrupt with a value of 31.
 * @param FRC_PRI_IRQn Represents the EFR32 FRC_PRI Interrupt with a value of
 * 32.
 * @param FRC_IRQn Represents the EFR32 FRC Interrupt with a value of 33.
 * @param MODEM_IRQn Represents the EFR32 MODEM Interrupt with a value of 34.
 ...
 * 37.
 * @param HOSTMAILBOX_IRQn Represents the EFR32 HOSTMAILBOX Interrupt with a
 * value of 38.
 * @param SYNTH_IRQn Represents the EFR32 SYNTH Interrupt with a value of 39.
 * @param ACMP0_IRQn Represents the EFR32 ACMP0 Interrupt with a value of 40.
 * @param ACMP1_IRQn Represents the EFR32 ACMP1 Interrupt with a value of 41.
 * @param WDOG0_IRQn Represents the EFR32 WDOG0 Interrupt with a value of 42.
 * @param WDOG1_IRQn Represents the EFR32 WDOG1 Interrupt with a value of 43.
 ...
 * @param HFRCOEM23_IRQn Represents the EFR32 HFRCOEM23 Interrupt with a value
 * of 46.
 * @param CMU_IRQn Represents the EFR32 CMU Interrupt with a value of 47.
 * @param AES_IRQn Represents the EFR32 AES Interrupt with a value of 48.
 * @param IADC_IRQn Represents the EFR32 IADC Interrupt with a value of 49.
 * @param MSC_IRQn Represents the EFR32 MSC Interrupt with a value of 50.
 * @param DPLL0_IRQn Represents the EFR32 DPLL0 Interrupt with a value of 51.
 * @param EMUEFP_IRQn Represents the EFR32 EMUEFP Interrupt with a value of 52.
 * @param DCDC_IRQn Represents the EFR32 DCDC Interrupt with a value of 53.
 * @param PCNT0_IRQn Represents the EFR32 PCNT0 Interrupt with a value of 54.
 * @param SW0_IRQn Represents the EFR32 SW0 Interrupt with a value of 55.
 * @param SW1_IRQn Represents the EFR32 SW1 Interrupt with a value of 56.
 * @param SW2_IRQn Represents the EFR32 SW2 Interrupt with a value of 57.
 * @param SW3_IRQn Represents the EFR32 SW3 Interrupt with a value of 58.
 ...
 * 62.
 * @param FPUEXH_IRQn Represents the EFR32 FPUEXH Interrupt with a value of 63.
 * @param SEMBRX_IRQn Represents the EFR32 SEMBRX Interrupt with a value of 65.
 * @param SEMBTX_IRQn Represents the EFR32 SEMBTX Interrupt with a value of 66.
 * @param SYSRTC_APP_IRQn Represents the EFR32 SYSRTC_APP Interrupt with a value
 * of 67.
 * @param SYSRTC_SEQ_IRQn Represents the EFR32 SYSRTC_SEQ Interrupt with a value
 * of 68.
 * @param KEYSCAN_IRQn Represents the EFR32 KEYSCAN Interrupt with a value of
 * 69.
 * @param RFECA0_IRQn Represents the EFR32 RFECA0 Interrupt with a value of 70.
 * @param RFECA1_IRQn Represents the EFR32 RFECA1 Interrupt with a value of 71.
 * @param VDAC0_IRQn Represents the EFR32 VDAC0 Interrupt with a value of 72.
 * @param VDAC1_IRQn Represents the EFR32 VDAC1 Interrupt with a value of 73.
 * @param AHB2AHB0_IRQn Represents the EFR32 AHB2AHB0 Interrupt with a value of
 * 74.
 * @param AHB2AHB1_IRQn Represents the EFR32 AHB2AHB1 Interrupt with a value of
 * 75.
 ******************************************************************************/
typedef enum IRQn{

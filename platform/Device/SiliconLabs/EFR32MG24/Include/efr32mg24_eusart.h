 ...
 * the configuration and status registers for an Enhanced Universal
 * Synchronous/Asynchronous Receiver/Transmitter (EUSART) module. It
 * includes various configuration registers (CFG0, CFG1, CFG2) for
 * setting up the EUSART's operational parameters, frame format, and
 * timing. The structure also contains registers for handling data
 * transmission and reception (TXDATA, RXDATA), status monitoring
 * (STATUS), and interrupt management (IF, IEN). Additionally, it
 ...
 * expansion, ensuring compatibility with future hardware updates.
 *
 ...
 * @param CFG2 Configuration 2 Register.
 * @param FRAMECFG Frame Format Register.
 * @param DTXDATCFG Default TX DATA Register.
 ...
 * @param DALICFG DALI Config Register.
 ...
 * @param CFG2_SET Configuration 2 Register.
 * @param FRAMECFG_SET Frame Format Register.
 * @param DTXDATCFG_SET Default TX DATA Register.
 ...
 * @param DALICFG_SET DALI Config Register.
 ...
 * @param CFG2_CLR Configuration 2 Register.
 * @param FRAMECFG_CLR Frame Format Register.
 * @param DTXDATCFG_CLR Default TX DATA Register.
 ...
 * @param DALICFG_CLR DALI Config Register.
 ...
 * @param CFG2_TGL Configuration 2 Register.
 * @param FRAMECFG_TGL Frame Format Register.
 * @param DTXDATCFG_TGL Default TX DATA Register.
 ...
 * @param DALICFG_TGL DALI Config Register.
